...
const Main = () => {
    const handleClickSub1 = () => {
        window.location.href = '/Looking4U'; 
    };
    const handleClickSub2 = () => {
        window.location.href = '/IamHere'; 
    };
    ...
    return (
        <div>
            ...
            <div className='mainContent'>
                ...
                <div className='sub1' onClick={handleClickSub1} style={{ cursor: 'pointer' }}>
                ...
                <div className='sub2' onClick={handleClickSub2} style={{ cursor: 'pointer' }}>
                ...
                <div className='sub3' onClick={handleClickSub3} style={{ cursor: 'pointer' }}>
                ...
                <div className='sub4' onClick={handleClickSub4} style={{ cursor: 'pointer' }}>
